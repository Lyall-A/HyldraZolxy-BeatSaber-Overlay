...
export class Plugins {
    ...
    // PRIVATE VARIABLE //
    //////////////////////
    isConnected = Globals.E_WEBSOCKET_STATES.DISCONNECTED;
    constructor() {
    ...
    // PRIVATE FUNCTION //
    //////////////////////
    webSocketConnection(pluginName, retryNumber, endPoint) {
    ...
    // PUBLIC FUNCTION //
    /////////////////////
    async beatSaberConnection() {
        await this.webSocketConnection(Globals.E_PLUGINS.BSPLUS, Globals.RETRY_NUMBER).then((socket) => {
            ...
            console.log("\n\n");
            await this.webSocketConnection(Globals.E_PLUGINS.HTTP_sira_STATUS, Globals.RETRY_NUMBER).then((socket) => {
                ...
                console.log("\n\n");
                await this.webSocketConnection(Globals.E_PLUGINS.DataPuller, Globals.RETRY_NUMBER, Globals.PLUGINS_CONNECTIONS.dataPuller.endPoint.mapData).then((socket) => {
                    console.log("socket initialized on DataPuller MapData!");
                    console.log("\n\n");
                    this.webSocketConnection(Globals.E_PLUGINS.DataPuller, Globals.RETRY_NUMBER, Globals.PLUGINS_CONNECTIONS.dataPuller.endPoint.liveData).then((socket2) => {
